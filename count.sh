...
WHOIS_ARCHIVE_ERROR_FOLDER="$WHOIS_ARCHIVE_FOLDER/error"
# START
echo "TODAY:"
...
COUNT_FILES=$(find $WHOIS_TODAY_ERROR_FOLDER -iname "*.$TLD.txt" -type f | wc -l)
echo "$TLD: $COUNT_FILES"
COUNT_FILES=$(ls "$WHOIS_TODAY_ERROR_FOLDER" | wc -l)
echo "ALL: $COUNT_FILES"
echo ""
...
COUNT_FILES=$(find $WHOIS_ARCHIVE_ERROR_FOLDER -iname "*.$TLD.txt" -type f | wc -l)
echo "$TLD: $COUNT_FILES"
COUNT_FILES=$(ls "$WHOIS_ARCHIVE_ERROR_FOLDER" | wc -l)
echo "ALL: $COUNT_FILES"
echo ""
